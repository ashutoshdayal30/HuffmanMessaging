...
Huffman Messaging is a small Java messaging demo built for CSC345. It connects a JavaFX chat window to a terminal-side console, then uses a Huffman tree to encode each message before the other side decodes and displays it.
...
```bash
cd ~/Desktop/HuffmanMessaging/HuffmanMessaging-main
```
